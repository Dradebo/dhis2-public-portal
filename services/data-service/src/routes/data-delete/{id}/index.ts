...
export const GET: Operation = async (
    ...
    try {
        ...
        const dataItemsConfigIds = req.query.dataItemsConfigIds 
            ? JSON.parse(decodeURIComponent(req.query.dataItemsConfigIds as string)) 
            : [];
...
GET.apiDoc = {
    ...
    parameters: [
        ...
        },
        {
            ...
            schema: { 
                type: "string",
                example: '{"periods":["202301","202302"],"pageSize":50,"paginateByData":false,"timeout":30000}'
            },
                ...
                "application/json": {
                    schema: {
                        ...
                        properties: {
                            ...
                            message: { 
                                type: "string",
                                example: "Data delete process started for config abc123",
